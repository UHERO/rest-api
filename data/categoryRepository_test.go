...
func TestGetAllCategories(t *testing.T) {
	...
	categoryResult := sqlmock.NewRows([]string{"id", "name", "ancestry", "geo", "freq", "start_date", "end_date"}).
		AddRow(category1.Id, category1.Name, nil, "HI", "A", nil, nil).
		AddRow(category2.Id, category2.Name, category2.Ancestry.String, nil, nil, nil, nil)
